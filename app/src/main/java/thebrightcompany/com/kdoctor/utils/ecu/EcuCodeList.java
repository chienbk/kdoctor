...
import thebrightcompany.com.kdoctor.utils.ecu.res.Messages;
	...
	implements Conversion
{
	...
	public EcuCodeList()
	{
		this("garainthepocket.codes");//codes");
	}
	...
	public EcuCodeList(String resourceBundleName)
	{
		...
		//codes = ResourceBundle.getBundle(resourceBundleName, Locale.ENGLISH);
